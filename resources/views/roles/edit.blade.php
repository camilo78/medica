        ...
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                    <a class="btn btn-primary mt-2 mt-xl-0" href="{{ route('roles.show',$role->id) }}"><i
                                ...
                                @foreach($permission->chunk(4) as $items)
                                    <div class="row">
                                        @foreach($items as $value)
                                            <div class="col-md-3">
                                                <p class="list-group-item mb-4">{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name')) }} {{ $value->name }}</p>
                                            </div>
                                        @endforeach
                                    </div>
                                @endforeach
